  ...
  return (
    <>
      <div className="flex mt-8 p-8">
        ...
        <div className="max-sm:mt-14 w-[300px]">
          <div className="flex flex-col gap-2 ">
            ...
            <div className="flex flex-row gap-4">
              ...
              <label className="block">
                ...
                <select className="block w-full mt-1 rounded-md text-black border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                  <option>1Kg</option>
                  <option>500g</option>
                  <option>250g</option>
                  <option>ALL</option>
            ...
            <div className="flex flex-col">
              ...
              <textarea className="mt-1 block text-black rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
            </div>
            ...
            <button className="bg-gray-600 w-24 mt-3 rounded-md p-1 mx-auto">
              Create
            </button>
          </div>
        </div>
